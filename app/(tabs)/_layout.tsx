...
import { Platform, View, Text, Image, ImageSourcePropType, TouchableOpacity } from 'react-native';
...
function CustomTabBar({ state, descriptors, navigation }: any) {
  ...
  const visibleTabs = new Set(['offerings', 'insights', 'parivar', 'chatbot', 'profile']);
